            ...
            <>
                <div className="block-default-pre" style={{
                    ...
                    <div className="preview-inside-block">
                        <p>
                            Наша платформа занимается размещением контекстной рекламы в публичных телеграм каналах. Мы предоставлем только целевой трафик а это значит что Ваша реклама не будет работать в пустую.
                            <br/>
                            Начать очень просто: зарегистрируйтесь, создайте свою первую рекламную кампанию уже сейчас.
                            <br/>
                            <br/>
                            Зарабатывате вместе с нами, регистрируйтесь, добавляйте в профиль свои телеграм каналы.
                            Мы опередилим тематику каналов, подберем контекстную рекламу под Вашу аудиторию, Вы получите процент за уникальный переход.
                        </p>
                    </div>
                </div>
                <div className="block-default-pre" style={{
