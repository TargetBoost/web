                            ...
                            :
                                <>
                                    ...
                                    <div className="block-default-pre" style={{fontSize: "13px", background: "#f2e4a8"}}>
                                        Добавьте нашего бота (<a href="https://t.me/targetBoostBot" className="underline">@targetBoostBot</a>) администраторов в Ваш телеграм канал, что бы мы могли отслеживать каких подписчиков привели мы.
                                    </div>
