                                ...
                                <div >
                                    ...
                                    <div className="wrapper-input">
                                        Телефон: <div className="button-default" onClick={()=>{
                                            window.location.href = `https://oauth.vk.com/authorize?client_id=51666136&display=page&redirect_uri=https://targetboost.ru/core/v1/callback_vk&scope=groups&response_type=code&v=5.131&state=${window.localStorage.getItem("token")}`
