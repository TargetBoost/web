        ...
        return (
            <>
                <div className="block-default-pre">
                    <h1>Правила</h1>
                    <div className="navigation-preview" style={{padding: "21px"}}>
                        <div className="block-text-pre">
                            <ol type="1">
                                ...
                                <li>(Оскарбление/токсичное поведение) в чате поддержки (бан).</li>
                                <li>Мы не меняем тип аккаунта. Вы "исполнитель" либо "заказчик".</li>
                                <li>Данные правила могут быть изменены или дополненны администрацией сайта в односторонеем порядке.</li>
                            </ol>
                        </div>
                    </div>
                </div>
