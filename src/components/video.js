            ...
            <>
                <div className="video-wrapper"  ref={this.fullScreen} >
                    <video onContextMenu={(event)=>{event.preventDefault()}} poster={poster} ref={this.obj} width="100%" id="video" controls={false} onPlay={this.play} onTimeUpdate={this.timerUpdate} onLoadedData={()=>{this.setState({actionState: "load"})}}>
                        <source
                            src="https://streaming.disk.yandex.net/hls/U2FsdGVkX19CFz__vDS_ZbutZlrEUUTBAPVGgTrJk-lQ02OsVjPh1SuJOVkjpRFcI87PYMVzrM1dXmv2vx9puNj2nb0dkBtGPBjBpFbqRO_P94YR4L_zbdBX6NP-rXy-7364aUkb-iWANQUVAVXb9hqxWY2unlWYBOfrrvW8uoC3vEqwymgUX-KnLLBbZ771sFVgI7UhuVuxcnc9m227xqSGonJjfV_pdykmK95PcxZd3YPkwi3_2JcMb4NFo5RA8NMDJ85AxmW7kWyEFDX37NOZK2u94gCTJdIaCzQq0I59OC4WW1XOkr7TdSC_05lAZ2D2HUljnMg1rNh-o71UVlnQildaRC1f85saBK23jmw/5fdf5ea15b3f8/2e9ac421d93388fd20f76cdf8b5b264554d1f18865a76b72a16e89602641358b/master-playlist.m3u8?partner-id=NaN&video-category-id=0&imp-id=undefined&gzip=1&from=disk&vsid=9d2c7fcb919ab303e98950ccc0d070456358594d0483xWEBx0467x1686521119&force_m4s=1"
                            type="video/mp4"
                        />
