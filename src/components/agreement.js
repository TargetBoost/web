                    ...
                    <div className="navigation-preview" style={{padding: "22px"}}>
                        <div className="block-text-pre">
                            <ol type="1">
                                ...
                                <li>(Оскорбление/токсичное поведение) в чате поддержки (бан).</li>
                                <li>Мы не меняем тип аккаунта. Вы "исполнитель" либо "заказчик".</li>
                                <li>Данные правила могут быть изменены или дополнены администрацией сайта в одностороннее порядке.</li>
                            </ol>
                        </div>
                    </div>
                </div>
