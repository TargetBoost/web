                        ...
                        <>
                            <div className="block-full-size">
                                ...
                                <div className="preview-inside-block">
                                    <p>
                                        Регистрируйтесь, создавайте задания, наши исполнители с радостью их выполнят 🙂
                                    </p>
                                </div>
                                {/*<div className="navigation-preview">*/}
                            ...
                            <div className="block-default-pre">
                                ...
                                <div className="navigation-preview">
                                    ...
                                    <div className="block-text-pre">
                                        Каналы Telegram - на данный момент самый популярный способ получения информации. Раскрутка телеграмм канала даст вам большее доверие потенциальной аудитории к каналу и как следствие более выраженный, но при этом естественный прирост подписчиков.                                    </div>
                                </div>
                            </div>
                            {/*<div className="block-default-pre">*/}
